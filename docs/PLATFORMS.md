...
|---|---|---|---|
| Android | `Android` | ARM64 | 2026-08-03 debug APK export and v2/v3 signature passed; no connected device; release key and physical-device QA remain |
| iOS | `iOS` | ARM64 + simulator framework | 2026-08-03 unsigned Xcode project export and inspection passed with temporary `CIUNSIGNED`; iOS 26.5 platform, real Team ID, signing and device QA remain |
| macOS | `macOS` | Universal | 2026-08-03 ad-hoc debug/release exports, signature checks and binary startups passed; release disabled Development Mode; Developer ID, notarization and full GUI QA remain |
| Windows | `Windows` | x86_64 | 2026-08-03 cross-export passed and PE structure verified; Windows runtime QA and optional Authenticode remain |
| Linux | `Linux` | x86_64 | 2026-08-03 cross-export passed and ELF structure verified; Linux X11/Wayland runtime QA remains |
