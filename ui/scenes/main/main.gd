...
func _l(zh: String, en: String) -> String:
	return AppLocalizer.text(zh, en, str(AppState.settings.get("language", "system")), OS.get_locale_language())

func _language() -> String:
	return AppLocalizer.resolve_language(str(AppState.settings.get("language", "system")), OS.get_locale_language())
...
func _show_difficulty(ranked: bool) -> void:
	...
	MainEntryViews.build_difficulty(self, content, ranked, _is_wide_layout())
